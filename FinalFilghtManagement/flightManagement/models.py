...
if __name__ == "__main__":
    with app.app_context():
        ...
        # #
        # ticket1 = Ticket(flight_id=1,  fare_class_id=1, customer_id=1, seat_id=12)
        # ticket2 = Ticket(flight_id=1, fare_class_id=2, customer_id=2, seat_id=13)
        # ticket3 = Ticket(flight_id=2, fare_class_id=1, customer_id=3, seat_id=14)
        # ticket4 = Ticket(flight_id=2, fare_class_id=2, customer_id=1, seat_id=15)
        # ticket5 = Ticket(flight_id=3, fare_class_id=1, customer_id=2, seat_id=16)
        # ticket6 = Ticket(flight_id=3, fare_class_id=2, customer_id=3, seat_id=17)
        # ticket7 = Ticket(flight_id=4, fare_class_id=1, customer_id=1, seat_id=18)
        # ticket8 = Ticket(flight_id=4, fare_class_id=2, customer_id=2, seat_id=19)
        # ticket9 = Ticket(flight_id=5, fare_class_id=1, customer_id=3, seat_id=20)
        # ticket10 = Ticket(flight_id=5, fare_class_id=2, customer_id=1, seat_id=21)
